...
# Install Bluez 5.47
#RUN apt-get install build-essential dbus --no-install-recommends -y
...
#    make && \
#    make install
#ENV LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:${JAVA_HOME}/lib/aarch32:${JAVA_HOME}/jre/lib/aarch32"
#RUN rm /etc/dbus-1/system.d/bluetooth.conf
#COPY bluetooth.conf /etc/dbus-1/system.d
#RUN usermod -a -G bluetooth openhab
